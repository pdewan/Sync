...
public class GenericChangeSet extends ChangeSet
{
   ...
   public GenericChangeSet(ObjectID obj_id, int size)
   {
      super(obj_id);
   ...
   public void addChange(ElementChange change)
   {
      ...
      Object old_value = changes.put(change.identifier(), change);
   }
   ...
   public static Vector makeHashtableObjectPairs(Hashtable htr, Hashtable ht0)
   {
      ...
      for (Enumeration e = all_keys.elements(); e.hasMoreElements(); ) {
         ...
         System.out.println("In makeHashtableObjectPairs(), Adding "+chpr.toString() + " key=" + key);
   ...
   public Enumeration enumerateChangePairs(ChangeSet C0)
   {
      ...
      if (C0 instanceof GenericChangeSet & !C0.isEmpty()) {
		 ...
		 //System.out.println("@@@@ In enumerateChangePairs, C0 not empty");
      }
      else {  // C0 is instance of NullSet
		  //System.out.println("@@@@ In enumerateChangePairs, C0 empty");
